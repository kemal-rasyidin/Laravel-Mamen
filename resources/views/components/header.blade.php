    ...
    <div class="container">
        <div class="relative flex items-center justify-between">
            <div class="px-0 sm:px-4">
                <a href="/" class="block py-6 text-lg font-bold text-white">
                    <p>Praktikan</p>
                </a>
            </div>
                    ...
                    <ul class="block py-2 lg:flex lg:py-0">
                        <li class="group">
                            <a href="{{ route('praktikans.index') }}"
                                ...
                                <svg class="flex h-4 lg:hidden" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="mr-14 px-4 lg:mr-0">
                <button type="button" class="mr-3 flex rounded-full bg-gray-800 text-sm md:mr-0" id="user-photo"
                ...
                <nav id="nav-user"
                    ...
                    <div class="mx-3 px-4 py-3">
                        ...
                        <span class="block truncate text-sm text-ink">boni@email.com</span>
                    </div>
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        <li>
                            <a href="#" class="group mx-4 flex rounded-md p-3 text-sm text-ink hover:bg-gray-200">
                                <svg class="h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 20 20">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2"
                                        d="M3 8v10a1 1 0 0 0 1 1h4v-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v5h4a1 1 0 0 0 1-1V8M1 10l9-9 9 9" />
                        ...
                        <li>
                            <a href="#" class="group mx-4 flex rounded-md p-3 text-sm text-ink hover:bg-gray-200">
                                <svg class="h-4" aria-hidden="true" viewBox="0 0 20 18" fill="none"
                        ...
                        <li>
                            <a href="#"
                                class="group mx-4 flex rounded-md p-3 text-sm text-ink hover:bg-gray-200 text-red-500">
                                <svg class="h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 16 16">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2"
